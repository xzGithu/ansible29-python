...
if __name__ == "__main__":
    a = prehosts(
        [u'192.168.181.79:888:insuser:1234qwer:22', u'192.168.181.131:333:insuser:1234qwer:22', u'192.168.181.131:22',
         u'192.168.181.79:22'])
    print(a)
    b = flinkmaster(["192.168.1.1:22:sss:eee:888:192.168.1.11,192.168.1.2:192,168,1,1,192.168.1.2,192.168.1.3:/app",
                     "192.168.1.2:22:sss:eee:888:192.168.1.1,192.168.1.2:192.168.1.1,192.168.1.2,'192.168.1.3:/app",
                     "192.168.1.3:22:sss:eee:888:192.168.1.1,192.168.1.2,192.168.1.11:192.168.1.1,192.168.1.2,192.168.1.3:/app"])
    print(b)
